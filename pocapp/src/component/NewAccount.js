      ...
      <Form className='container col-md-6' onSubmit={handleSubmit}>
        ...
        <div style={{ textAlign: 'initial' }}>
          ...
          <Form.Group className="mb-3 " controlId="formBasicEmail">
            <Form.Label className="d-flex">Customer ID</Form.Label>
            <Form.Control
              className="d-flex"
              autoComplete='off'
              type="text"
          ...
          <Form.Group className="mb-3 " controlId="formBasicEmail">
            <Form.Label className="d-flex">Account Type</Form.Label>
            <Form.Select
              className="d-flex"
              autoComplete='off'
              type="text"
          ...
          <Form.Group className="mb-3 " controlId="formBasicEmail">
            <Form.Label className="d-flex">Initial Deposit</Form.Label>
            <Form.Control
              className="d-flex"
              autoComplete='off'
              type="number"
